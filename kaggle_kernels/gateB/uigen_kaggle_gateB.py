...
run_dir = RUNS_DIR / "v7_completer_gateB_16skin"
...
print("\nGATEB_RESULT: TRAINED" if all(s["rc"] == 0 for s in summaries) else "GATEB_RESULT: FAIL", flush=True)
